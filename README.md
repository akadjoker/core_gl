...
Tests: `clear`, `triangle`, `occlusion`, `rendertarget`, `batch`, `shapes3d`,
`bunny` (bunnymark -- hold the mouse to pour bunnies, C clears), `bench`,
`verify` (pixel-exact readback assertions), `compute` (SSBO round-trip).
